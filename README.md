...
#### ⚖️ [Tie-Breaker-App](https://github.com/Ahtesham-Latif/Tie-Breaker-App) `Deployed`
...
* **Stack:** React, Node.js, GitHub Actions (CI/CD).
* **Features:** Dynamic Principal & Interest calculations, side-by-side scenario comparisons, and visual analytics.
* **Deployment:** Automated CI/CD pipeline directly to **Azure App Service**.
* **Live App:** [👉 Try it out here](https://llyodbanking-mortgage-calculator-h0gmadcfh0bvb3eh.westeurope-01.azurewebsites.net/)
...
* **Live App:** [👉 Try it out here](https://ahteshamlatiflogicchatbot.vercel.app/)

#### 📊 [Quantium_job_simulation](https://github.com/Ahtesham-Latif/Quantium_job_simulation)
*Sales data pipeline and interactive dashboard.*
* **ETL:** Cleans and unifies fragmented Pink Morsel sales data.
...
| Issuer | Highlights |
| :--- | :--- |
| **Anthropic** | Claude_101, AI Fluency: Framework and Foundations |
| **Google** | AI Essentials, Prompting Essentials, AI for Data Analysis |
| **Forage** | Quantium SE, Deloitte Data Analytics, DATACOM AI |
| **Kaggle** | Intro to Programming |
| **HP LIFE** | Data Science and Analytics, Agile Project Management |

👉 [View My Full Badge Wallet on Credly](https://www.credly.com/users/f23ba044-ahtesham-latif)

---

### 📧 Contact Me
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=flat&logo=linkedin&logoColor=white)](https://linkedin.com/in/ahtesham-latif) 
**Email:** ahteshamlatif22@gmail.com
